...
# This is the canonical text of the audit. The README in Phase 11 will
# reference it directly. Keeping it in one place (this notebook) means
# updates land in one place, not three.
...
print(f"   In Phase 10, copy to repo root and `chmod +x precommit_audit.sh`.")
...
```python
# notebooks/phase_8/03_pre_commit_audit.py — SAFE
